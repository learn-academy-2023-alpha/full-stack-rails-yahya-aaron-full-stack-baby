...
XHas a model for Blog with the following information: title and content
XHas a controller for Blog
XHas a controller action for index
XHas a route for index
XHas a view for index
XCan see all the blog post titles on the landing page of the application
...
xHas a controller action for show
xHas a route for show
xHas a view for show
xCan navigate from the list of all blog post titles to the view of any given blog post
xCan see all the title and content for one blog post on a page
xCan navigate back from the show page to the landing page
